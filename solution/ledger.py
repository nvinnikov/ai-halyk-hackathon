...
# («9 876,54», «7,5») либо запятая правее точки («9.876,54»). Разделитель тысяч
# («9,876.54») под шаблон не подпадает — за его запятой ровно три цифры.
...
def parse_amount(raw: str) -> Decimal | None:
    ...
    # превращало бы «9 876,54» в 987654 (×100), а «9.876,54» в 9.87654 (÷1000)
