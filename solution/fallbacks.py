...
def prior_status(
    ...
    Пункт первым — по LOBO-замеру: 27/36 против 25/36 у порядка семья→пункт
    (при AST-классификации семей; ручная давала 22/36). Сдвиг пунктов несёт
    почти весь сигнал (6.1 — 10/12 BREACH, 6.2 — 10/12 COMPLIANT), а самая
    населённая семья absolute размазана 7/14. Порядок совпадает с докстрингом
    eval/prior.py."""
