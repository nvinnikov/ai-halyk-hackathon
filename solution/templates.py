...
# Шаблоны «по категории»: сам заголовок говорит, что категория — параметр
# пункта, а не часть формы метрики. На публичном наборе оба таких пункта были
# про одну категорию (CAPEX / REVENUE), и она запеклась в канонический DSL;
# на чужом наборе тот же заголовок накрывает любую статью, и категорию надо
# брать из тела пункта — то есть из извлечённой формулы.
CATEGORY_PARAMETERIZED = frozenset({"capex", "revenue"})
