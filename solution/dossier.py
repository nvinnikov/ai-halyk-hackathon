...
# v8 — то же правило распространено на черновики (NON_EFFECTIVE_EDITIONS):
# промежуточные ведомости аудитора несли по одной предварительной
# реклассификации каждая, и обе искажали по ячейке.
        ...
        def build(acc=acc) -> dict:
            ...
            for dtype in sorted(by_type):
                ...
                if dtype in CUMULATIVE_TYPES:
                    ...
                    # единственный (см. NON_EFFECTIVE_EDITIONS).
