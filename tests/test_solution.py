...
#
# 35.00 здесь ещё и настоящий максимум набора, а не просто текущий уровень:
# оставшаяся ячейка (P4 6.3) расходится из-за опечатки в самом датасете —
# организаторы подтвердили, что порог в договоре загрузился неверно, а ключ
# правильный. Совпасть с ключом на ней можно только зашив порог руками, поэтому
# 36.00 честными средствами недостижимо: скор выше 35.00 означает подгонку.
MAX_SCORE = 35.00
